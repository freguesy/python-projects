...
in5 = Entry(frame2, font='Bahnschrift').grid(row=0, column=1,sticky=EW,columnspan=5)
...
lb7 = Label(frame2, text='Bairro:',font='Bahnschrift',background='black',foreground="white").grid(row=1, column=2,sticky=EW)
in7 = Entry(frame2, font='Bahnschrift').grid(row=1, column=3,sticky=EW)

lb8 = Label(frame2, text='Cidade',font='Bahnschrift',background='black',foreground="white").grid(row=1, column=4,sticky=EW)
in8 = Entry(frame2, font='Bahnschrift').grid(row=1, column=5,sticky=EW)
